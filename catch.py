...
def calculate_catch_probability(my_pokemon_hp, my_pokemon_attack, wild_pokemon_hp, wild_pokemon_attack):
...
def try_catch_pokemon(my_pokemon_hp, my_pokemon_attack, wild_pokemon_hp, wild_pokemon_attack):
    catch_probability = calculate_catch_probability(my_pokemon_hp, my_pokemon_attack, wild_pokemon_hp, wild_pokemon_attack)
    
    print(f"포획 확률: {catch_probability:.2f}%")
